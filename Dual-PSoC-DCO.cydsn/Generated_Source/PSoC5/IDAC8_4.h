...
#define IDAC8_4_DEFAULT_RANGE     8u                                   /* Default DAC range */
#define IDAC8_4_DEFAULT_SPEED     ((uint8)(((0u != 0u) ? 1u : 0u) << 1u))   /* Default DAC speed */
#define IDAC8_4_DEFAULT_CNTL      0x00u                                            /* Default Control */
#define IDAC8_4_DEFAULT_STRB     0u                                   /* Default Strobe mode */
#define IDAC8_4_DEFAULT_DATA     120u                                 /* Initial DAC value */
#define IDAC8_4_DEFAULT_POLARITY 2u                                      /* Default Sink or Source */
