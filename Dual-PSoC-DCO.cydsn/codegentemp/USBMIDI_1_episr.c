    ...
    CY_ISR(USBMIDI_1_ARB_ISR)
    {
        ...
        while (0u != arbIntrStatus)
        {
            ...
            if (0u != (arbIntrStatus & 0x01u))
            {
                ...
                if (0u != (epStatus & USBMIDI_1_ARB_EPX_INT_DMA_TERMIN))
                {
                    ...
                    USBMIDI_1_DmaEpBurstCnt[ep] = USBMIDI_1_DmaEpBurstCntBackup[ep];
        ...
        ******************************************************************************/
        void USBMIDI_1_EP1_DMA_DONE_ISR(void)
        {
            ...
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP1])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP1];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP1_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP1] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP1] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            if (0u != (USBMIDI_1_EP[USBMIDI_1_EP1].addr & USBMIDI_1_DIR_IN))
            {
                ...
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP1_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP1_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP1]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP2_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP2])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP2];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP2_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP2] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP2] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP2_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP2_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP2]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP3_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP3])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP3];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP3_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP3] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP3] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP3_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP3_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP3]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP4_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP4])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP4];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP4_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP4] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP4] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP4_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP4_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP4]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP5_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP5])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP5];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP5_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP5] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP5] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP5_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP5_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP5]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP6_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP6])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP6];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP6_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP6] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP6] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable the DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP6_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP6_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP6]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP7_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP7])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP7];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP7_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP7] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP7] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP7_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP7_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP7]);
        }
        ...
        ******************************************************************************/
        void USBMIDI_1_EP8_DMA_DONE_ISR(void)
        {
            ...
            /* Manage data elements which remain to transfer. */
            if (0u != USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP8])
            {
                /* Decrement burst counter. */
                --USBMIDI_1_DmaEpBurstCnt[USBMIDI_1_EP8];
            }
            else
            {
                /* Adjust length of last burst. */
                USBMIDI_1_CyDmaSetNumDataElements(USBMIDI_1_EP8_DMA_CH,
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP8] >> USBMIDI_1_DMA_DESCR_SHIFT),
                                                        ((uint32) USBMIDI_1_DmaEpLastBurstEl[USBMIDI_1_EP8] &  USBMIDI_1_DMA_BURST_BYTES_MASK));
            }
            ...
            {
                /* Change source for descriptor 0. */
                nextAddr = (uint32) USBMIDI_1_CyDmaGetSrcAddress(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change source for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetSrcAddress(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }
            else
            {
                /* Change destination for descriptor 0. */
                nextAddr  = (uint32) USBMIDI_1_CyDmaGetDstAddress(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR0);
                nextAddr += (2u * USBMIDI_1_DMA_BYTES_PER_BURST);
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR0, (void *) nextAddr);

                /* Change destination for descriptor 1. */
                nextAddr += USBMIDI_1_DMA_BYTES_PER_BURST;
                USBMIDI_1_CyDmaSetDstAddress(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR1, (void *) nextAddr);
            }

            /* Enable DMA to execute transfer as it was disabled because there were no valid descriptor. */
            USBMIDI_1_CyDmaValidateDescriptor(USBMIDI_1_EP8_DMA_CH, USBMIDI_1_DMA_DESCR0);
            USBMIDI_1_CyDmaChEnable (USBMIDI_1_EP8_DMA_CH);
            USBMIDI_1_CyDmaTriggerIn(USBMIDI_1_DmaReqOut[USBMIDI_1_EP8]);
        }
